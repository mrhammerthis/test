...
- Auto-equip inventory flow:
  - new gear pops an inventory overlay automatically,
  - gear is auto-equipped immediately,
  - drops can unlock new spells (Void Nova) or strengthen existing spells.
- Menus + hotkeys:
  - `I` toggles inventory menu,
  - `Esc` toggles pause menu,
  - `` ` `` toggles developer cheat menu.
